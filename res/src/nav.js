        ...
        <div class="nav-container">
            ...
            <div class="nav-menu" id="navMenu">
                <ul class="nav-list">
                    ...
                    <li><a href="/ru/projects" class="nav-link">Проекты</a></li>
                    <li><a href="/ru/blog" class="nav-link">Блог</a></li>
                    <li><a href="/ru/about" class="nav-link">О себе</a></li>
                    <li><a href="/ru/settings" class="nav-link">Настройки</a></li>
                </ul>
            </div>
        </div>
    `;
